...
\[
\text{Maintainability Index} = 
\max\left(0, \left(171 - 
5.2 \times \log(\text{Halstead Volume}) - 
0.23 \times (\text{Cyclomatic Complexity}) - 
16.2 \times \log(\text{Lines of Code}) 
\right) \times \frac{100}{171}\right)
\]
