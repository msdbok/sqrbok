...
\[
\text{Maintainability Index} = \text{MAX}\left(0, \left(171 - 5.2 \times \log(\text{Halstead Volume}) - 0.23 \times (\text{Cyclomatic Complexity}) - 16.2 \times \log(\text{LOC})\right) \times 100 / 171\right)
\]
