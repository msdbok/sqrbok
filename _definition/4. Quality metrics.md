...
2. **Ordinal**: Ordered categories without magnitude.  
3. **Interval**: Ordered with magnitude, but no true zero.  
4. **Ratio**: Ordered with magnitude and a true zero.  
5. **Absolute**: Fixed, countable quantities.

### Significance:
- The level of measurement determines the permissible mathematical manipulations and statistical analyses.

---

## Six-Step Process for Developing Metrics

![Six-Steps](//www.plantuml.com/plantuml/png/9SpFQiCm3CVnkvz2Bn33_co7x9AnGKw1hIszYqIX0biEbbn8dxvsUnCVlleDQfYjnE0UX-jVFFpIoa8m9WpwvVfN3oC9PJI2_q9gdAJvcuVZHZElEqo4MZ8rVM__LmffgpfVK5XZymyFPmoyj1MK1Ru5mtuZO843OUXE7Abcdnv-aYnbDlXBQjsKib5yrifrI2rjRg2Qn707)
