...
![McCall's Quality Factors](mccall.png)  
...
flowchart LR
  ...
  B --> B1[Correctness ✅, Reliability 🔒, Efficiency ⚡, Integrity 🔐, Usability 🖥️]
  C --> C1[Maintainability 🔄, Flexibility 🛠️, Testability 🧪]
  D --> D1[Portability 🌍, Reusability ♻️, Interoperability 🔗]
```
